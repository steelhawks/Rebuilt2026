...
public class BuilderConstants {
    ...
    public static class OmegaBot {
        ...
        public static final TurretConstants TURRET = new TurretConstants(4, 9, 3000.0, 0.0, 100.0, 5.5, 0.0, 20.0, 30.0, 1.0 / 1.0, Rotation2d.fromRadians(-2.284097), Rotation2d.fromRadians(6.1261), Rotation2d.fromRotations(0.064697265625));
