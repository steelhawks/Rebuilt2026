...
public class FlywheelIOTalonFX implements FlywheelIO {
    ...
    public FlywheelIOTalonFX(RobotConfig.CANBus bus, SubsystemConstants.FlywheelConstants constants) {
        leftMotor = new TalonFX(constants.leftMotorId(), bus.bus);
        ...
        rightMotor = new TalonFX(constants.rightMotorId(), bus.bus);
