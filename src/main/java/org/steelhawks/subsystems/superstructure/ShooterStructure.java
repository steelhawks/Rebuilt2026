...
//        shootingTimeOfFlightMap.put(1.405, 1.296);
    ...
    public static void loadLUTSolved() {
        ...
        shootingFlywheelVelocityMap.put(1.400, 10.50);
        shootingFlywheelVelocityMap.put(1.933, 10.70);
        shootingFlywheelVelocityMap.put(2.467, 10.70);
        shootingFlywheelVelocityMap.put(3.000, 11.19);
        shootingFlywheelVelocityMap.put(3.533, 11.67);
        shootingFlywheelVelocityMap.put(4.067, 12.25);
        shootingFlywheelVelocityMap.put(4.600, 12.85);
        shootingFlywheelVelocityMap.put(5.133, 13.45);
        shootingFlywheelVelocityMap.put(5.667, 14.02);
        shootingFlywheelVelocityMap.put(6.200, 14.58);

        shootingHoodAngleMap.put(1.400, Rotation2d.fromDegrees(77));
        shootingHoodAngleMap.put(1.933, Rotation2d.fromDegrees(72));
        shootingHoodAngleMap.put(2.467, Rotation2d.fromDegrees(65));
        shootingHoodAngleMap.put(3.000, Rotation2d.fromDegrees(60));
        shootingHoodAngleMap.put(3.533, Rotation2d.fromDegrees(57));
        shootingHoodAngleMap.put(4.067, Rotation2d.fromDegrees(54));
        shootingHoodAngleMap.put(4.600, Rotation2d.fromDegrees(53));
        shootingHoodAngleMap.put(5.133, Rotation2d.fromDegrees(53));
        shootingHoodAngleMap.put(5.667, Rotation2d.fromDegrees(52));
        shootingHoodAngleMap.put(6.200, Rotation2d.fromDegrees(51));

        shootingTimeOfFlightMap.put(1.400, 1.026);
        shootingTimeOfFlightMap.put(1.933, 1.015);
        shootingTimeOfFlightMap.put(2.467, 0.928);
        shootingTimeOfFlightMap.put(3.000, 0.922);
        shootingTimeOfFlightMap.put(3.533, 0.937);
        shootingTimeOfFlightMap.put(4.067, 0.977);
        shootingTimeOfFlightMap.put(4.600, 1.035);
        shootingTimeOfFlightMap.put(5.133, 1.111);
        shootingTimeOfFlightMap.put(5.667, 1.156);
        shootingTimeOfFlightMap.put(6.200, 1.197);
    }
}
