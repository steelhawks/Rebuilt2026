...
//        shootingTimeOfFlightMap.put(1.405, 1.296);
    ...
    // (ideal ball exit / eta_slip * wear). If you re-tune the slip slider,
    ...
    //   ball condition    0.89
    //   eta x wear          0.667
    //   hood angle bias   +0.0 deg  (slo-mo offset)
    ...
    public static void loadLUTSolved() {
        ...
        shootingFlywheelVelocityMap.put(1.743, 10.71);
        shootingFlywheelVelocityMap.put(2.086, 11.16);
        shootingFlywheelVelocityMap.put(2.429, 10.66);
        shootingFlywheelVelocityMap.put(2.771, 11.04);
        shootingFlywheelVelocityMap.put(3.114, 11.42);
        shootingFlywheelVelocityMap.put(3.457, 11.78);
        shootingFlywheelVelocityMap.put(3.800, 12.10);
        shootingFlywheelVelocityMap.put(4.143, 12.46);
        shootingFlywheelVelocityMap.put(4.486, 12.81);
        shootingFlywheelVelocityMap.put(4.829, 13.16);
        shootingFlywheelVelocityMap.put(5.171, 13.56);
        shootingFlywheelVelocityMap.put(5.514, 13.89);
        shootingFlywheelVelocityMap.put(5.857, 14.23);
        shootingFlywheelVelocityMap.put(6.200, 14.62);

        shootingHoodAngleMap.put(1.743, Rotation2d.fromDegrees(72));
        shootingHoodAngleMap.put(2.086, Rotation2d.fromDegrees(71));
        shootingHoodAngleMap.put(2.429, Rotation2d.fromDegrees(62));
        shootingHoodAngleMap.put(2.771, Rotation2d.fromDegrees(61));
        shootingHoodAngleMap.put(3.114, Rotation2d.fromDegrees(59));
        ...
        shootingHoodAngleMap.put(5.171, Rotation2d.fromDegrees(54));
        ...
        shootingTimeOfFlightMap.put(1.743, 1.065);
        shootingTimeOfFlightMap.put(2.086, 1.122);
        shootingTimeOfFlightMap.put(2.429, 0.916);
        shootingTimeOfFlightMap.put(2.771, 0.959);
        shootingTimeOfFlightMap.put(3.114, 0.998);
        shootingTimeOfFlightMap.put(3.457, 1.032);
        shootingTimeOfFlightMap.put(3.800, 1.036);
        shootingTimeOfFlightMap.put(4.143, 1.063);
        shootingTimeOfFlightMap.put(4.486, 1.087);
        shootingTimeOfFlightMap.put(4.829, 1.108);
        shootingTimeOfFlightMap.put(5.171, 1.181);
        shootingTimeOfFlightMap.put(5.514, 1.198);
        shootingTimeOfFlightMap.put(5.857, 1.213);
        shootingTimeOfFlightMap.put(6.200, 1.282);
    }
}
